				...
				<div className="EditHabitInfo">
								...
								<p className="habit-create-steps">
									...
									>
										<Typography className={classes.typography}>
											...
											The 2 most common cues are time and location. People who
											make a specific plan for when and where they will perform
											a new habit are more likely to follow through. Don't leave
											it up to chance and hope we will just remember to do it or
											feel motivated at the right time.
										</Typography>
									</Popover>
								</p>
							</span>
					...
					<div className="create-infoBorder">
						<Card variant="outlined" style={{ backgroundColor: "beige" }}>
								...
								<p className="habit-create-steps">
									...
									>
										<Typography className={classes.typography}>
											...
											Pair an action you WANT to do with an action you NEED to
											do. We often decide what to do next based on what we have
											just finished doing. No behavior happens in isolation.
											Each action becomes a cue that triggers the next behavior.
											Idenify a current habit you already do each day and then
							...
							<div className="habit-example">
								Ex: After I
								<span className="habit-inputs"> watch my tv show </span> , I
								will
								...
								<p className="habit-create-steps">
									...
									>
										<Typography className={classes.typography}>
											...
											When starting a new habit or on unmotivating days,
											complete your habit in less than 2 minutes. Your goal
											might be to run a marathon, but your gateway habit is to
											put on your running shoes. It's better to do less than you
											hoped than to do nothing at all. Ex. Write 1 sentence,
											open your study notes, etc.
										</Typography>
									</Popover>
								</p>
							</span>
								...
								<p className="habit-create-steps">
									...
									>
										<Typography className={classes.typography}>
											...
											Always stay below the point where the habit feels like
											work. Stop before it seems like a hassle. Master the habit
											of showing up: A habit must be established before it can
											be improved. Ex. Write 1 paragraph, study for 15 min, etc.
										</Typography>
									</Popover>
								</p>
							</span>
								...
								<p className="habit-create-steps">
									...
									>
										<Typography className={classes.typography}>
											...
											combine the 2-minute rule with habit shaping to scale the
											habit back up toward your ultimate goal. Nearly any larger
											life goal can be transformed into a 2-minute behavior. Ex.
											Write 1,000 words, study for 3 hours, etc.
										</Typography>
									</Popover>
								</p>
							</span>
					...
					<div className="create-infoBorder">
						<Card variant="outlined" style={{ backgroundColor: "beige" }}>
								...
								<p className="habit-create-steps">
									...
									>
										<Typography className={classes.typography}>
											...
											We're more likely to repeat a behavior when the experience
											is satisfying. Give yourself an immediate reward when you
											complete your habit. Pleasure teaches your brain that a
											behavior is worth remembering and repeating. When is
											reward is repeated. What is punished is avoided.
										</Typography>
									</Popover>
								</p>
							</span>
							...
							<div className="habit-example">
								Ex: After I<span className="habit-inputs"> exercise </span> , I
								will
